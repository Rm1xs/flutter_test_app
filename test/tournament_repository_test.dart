...
import 'package:flutter_test_app/features/tournaments/data/models/tournament_model.dart' show TournamentModel;
...
void main() {
  ...
  test('Load and compare lists', () async {
    ...
    when(mockRepository.fetchTournaments()).thenAnswer((_) async => tournaments);


    await controller.fetchTournaments();

    expect(controller.tournaments, equals(tournaments));
